      ...
      <div class="section employee-card-section pt-1">
          <div class="employee-card">
            ...
            <div class="issue-penalty-button">
                <button @click="issuePenalty" class="btn btn-primary">Issue Penalty</button>
            </div>
          </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="rejectionModalLabel">Provide Rejection Message</h5>
                        ...
                        <div class="modal-footer">
                          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                            <button @click="rejectPenalty()" class="btn btn-danger">Reject with Message</button>
                        </div>
                    </div>
                </div>
            </div>
...
<style scoped>
  .penalty-table {
    ...
    margin-top: 15px; /* Add some top margin for the entire table */
  }

  .penalty-table th,
  .penalty-table td {
    padding: 10px; /* Add padding around each cell */
    text-align: left;
  ...
  .penalty-table td {
    width: 30%; /* Set a specific width for the last column */
  }

  .penalty-table td button {
    margin-right: 50px; /* Add more right margin for the buttons */
  }

  .issue-penalty-button {
    margin-top: 15px; /* Add margin to the Issue Penalty button */
  }
